...
namespace myIS
{
    public partial class AddDomain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bool flag = false;
            string strSql = "INSERT INTO [domain] ([date],[description],[dname],[OwnerMail],[maxNumOfPartner],[city],[street],[maker_date]) VALUES (?,?,?,?,?,?,?,?)";
            // 
              ...
              try
               {
                ...
                if (flag)
                {
                    SuccessfulDomainAdded fmd = new SuccessfulDomainAdded();
